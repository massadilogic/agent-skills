...
name: app-pr
description: >
  Creates Pull Requests for {Application} following the project template and conventions.
...
- [ ] This feature/issue is listed in [here](https://github.com/{author}/app/issues?q=sort%3Aupdated-desc+is%3Aissue+is%3Aopen) or roadmap.app.com
- [ ] Is it assigned to me, if not, request it via the issue/feature in [here](https://github.com/{author}/app/issues?q=sort%3Aupdated-desc+is%3Aissue+is%3Aopen) or [{Application} Community Slack](goto.app.com/slack)
...
|-----------|-----------|--------------|
| SDK | `app/CHANGELOG.md` | New checks → permissions update? |
