...
# Current path: agents/context/skills/setup.sh
# Expected root: agents/
# So we need to go up 2 levels: setup.sh -> skills -> context -> agents
...
show_help() {
    ...
    echo ""
    echo "Configure AI coding assistants for Project development."
    echo ""
    echo "Options:"
